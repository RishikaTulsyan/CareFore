...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment);
         ...
         getIntent().getExtras();
        Toolbar setupToolbar = findViewById(R.id.payment);
        setSupportActionBar(setupToolbar);
        getSupportActionBar().setTitle("Money Donation");
            ...
            send.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String name = new String("Rishika_Tulsyan");
                    String upiId = new String("rishika.7143@okicici");
    ...
    private void initializeViews() {
        ...
        String nameEt = new String("Rishika_Tulsyan");
        String upiIdEt = new String("rishika.7143@okicici");
